...
namespace Learning.DAL
{
	...
	public partial class RoleModel
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Id", "RoleModel"); 
		}
		...
		public bool Exists(int Id)
		{
			...
			strSql.Append("select count(1) from RoleModel");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Learning.Model.RoleModel model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into RoleModel(");
			strSql.Append("RoleId,TreeNodeId,ButtonId)");
			...
			parameters[1].Value = model.TreeNodeId;
			parameters[2].Value = model.ButtonId;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Learning.Model.RoleModel model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update RoleModel set ");
			strSql.Append("RoleId=@RoleId,");
			strSql.Append("TreeNodeId=@TreeNodeId,");
		...
		public bool Delete(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from RoleModel ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Learning.Model.RoleModel GetModel(int Id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Id,RoleId,TreeNodeId,ButtonId from RoleModel ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
			...
			Learning.Model.RoleModel model=new Learning.Model.RoleModel();
		...
		/// 得到一个对象实体
		/// </summary>
		public Learning.Model.RoleModel DataRowToModel(DataRow row)
		{
			Learning.Model.RoleModel model=new Learning.Model.RoleModel();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,RoleId,TreeNodeId,ButtonId ");
			strSql.Append(" FROM RoleModel ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Id,RoleId,TreeNodeId,ButtonId ");
			strSql.Append(" FROM RoleModel ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from RoleModel T ");
