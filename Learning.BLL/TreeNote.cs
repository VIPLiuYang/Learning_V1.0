...
namespace Learning.BLL
{
	...
	{
		private readonly Learning.DAL.TreeNote dal=new Learning.DAL.TreeNote();
		public TreeNote()
		{}
		#region  BasicMethod
		...
		{
			return dal.DeleteList(TreeNodeIdlist );
		}
		...
		public Learning.Model.TreeNote GetModel(int TreeNodeId)
		{
			...
			return dal.GetModel(TreeNodeId);
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Learning.Model.TreeNote> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Learning.Model.TreeNote> DataTableToList(DataTable dt)
		{
			List<Learning.Model.TreeNote> modelList = new List<Learning.Model.TreeNote>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Learning.Model.TreeNote model;
