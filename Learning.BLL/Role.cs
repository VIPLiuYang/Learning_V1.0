...
namespace Learning.BLL
{
	...
	{
		private readonly Learning.DAL.Role dal=new Learning.DAL.Role();
		public Role()
		{}
		#region  BasicMethod
		...
		/// 获得数据列表
		/// </summary>
		public List<Learning.Model.Role> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Learning.Model.Role> DataTableToList(DataTable dt)
		{
			List<Learning.Model.Role> modelList = new List<Learning.Model.Role>();
